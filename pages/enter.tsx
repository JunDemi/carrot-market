  ...
  return (
    <div className="mt-16 px-4">
      ...
      <div className="mt-12">
        {data?.ok ? (
          <form
            onSubmit={t_handleSubmit(onTokenValid)}
            className="flex flex-col mt-8 space-y-4"
          >
            <Input
              register={t_register("token", {
                required: true
              })}
              name="token"
              ...
              required
            />
            <Button text={t_loading ? "Loading" : "Confirm Token"} />
          </form>
        ) : (
          <>
